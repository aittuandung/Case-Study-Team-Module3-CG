            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="property-agent">
                  <h4 class="title-agent">${apartment.customer.fullName}</h4>
                  <ul class="list-unstyled">
                    <li class="d-flex justify-content-between">
                      <strong>Điện Thoại Liên Hệ:</strong>
                      <span class="color-text-a">${apartment.customer.phoneNumber}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Sinh Nhật:</strong>
                      <span class="color-text-a">${apartment.customer.birthDay}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Email:</strong>
                      <span class="color-text-a">${apartment.customer.email}</span>
                    </li>
                  </ul>
                  <div class="socials-a">
